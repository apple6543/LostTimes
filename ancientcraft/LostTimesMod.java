package net.mcreator.ancientcraft;
...
import net.mcreator.ancientcraft.init.LostTimesModVillagerProfessions;
import net.mcreator.ancientcraft.init.LostTimesModTabs;
...
@Mod("lost_times")
public class LostTimesMod {
	public static final Logger LOGGER = LogManager.getLogger(LostTimesMod.class);
	public static final String MODID = "lost_times";

	public LostTimesMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		LostTimesModBlocks.REGISTRY.register(modEventBus);
		LostTimesModItems.REGISTRY.register(modEventBus);
		LostTimesModEntities.REGISTRY.register(modEventBus);
		LostTimesModTabs.REGISTRY.register(modEventBus);
		LostTimesModVillagerProfessions.PROFESSIONS.register(modEventBus);
